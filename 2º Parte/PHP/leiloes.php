	...
	<body>
		<div class="wrap">
			...
			<?php
				...
				echo "<br><p class='grande'>Leilões em curso</p>";
				echo "<p class='pequeno'>Aqui pode ver os leilões que estão a decorrer ou irão decorrer no futuro.<br>";
				...
				if($count == 0){ // se não houverem leilões a decorrer, não imprime a tabela, mas antes uma mensagem de aviso
					echo "<div class='grande'>Não existem leilões a decorrer neste momento.</div>";
					goto leave;
				}
				...
				for($i=0; $i<$count; $i=$i+1){
					...
					echo "<input type='checkbox' name='choose[]' value='$lid'><input type='hidden' id='e$idleilao' value='$estado'></td>";
					echo "<td>$nif</td>";
				...
				echo "</table><input type='submit' value='Concorrer aos leilões seleccionados'></form></center>";
